...
const AboutUs = () => {
    return (
        <div className="bg-gradient-to-r mt-0 box-border flex flex-col md:flex-row items-center md:items-start pr-10 pl-10 pt-5 from-green-200 to-white min-h-screen font-sans">
            <div className="w-full md:min-w-2/3 min-h-screen pl-5 pr-5 md:pl-10 md:pr-16 font-serif flex flex-col items-center md:items-start">
                <div className="w-full md:w-auto text-center md:text-left">
                    ...
                    <p className="text-[16px] md:text-[18px] leading-relaxed">
                        Welcome PLANTERS, your ultimate destination for all
                        things plants! Our passionate team shares tips, guides,
                        and inspiration to make your plant journey easy and
                        enjoyable. We’re committed to fostering a global
                        community of plant lovers and promoting sustainable
                        practices.
                    </p>
                </div>

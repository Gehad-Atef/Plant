...
const PlantShop = () => {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:7286/api/plant") //"https://greenland.runasp.net/api/plant"
      .then((response) => {
  ...
  return (
    ...
    >
        ...
        <div className=" h-[100%] w-[94%] mx-[3%] flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="h-full w-full md:w-1/2  py-10 px-20 text-center md:px-20 md:text-left ">
            ...
            <p className="my-10 text-lg">
              Learn the art of combining plants, soil, and decorative elements
              to craft a thriving, self-sustaining ecosystem.
            </p>
          ...
          >
            <div
              className={`w-[320px] h-[160px] absolute right-10 bottom-10  rounded-xl shadow-lg ${
                darkMode ? "bg-gray-900 text-white" : " text-gray-900 bg-white"
              }`}
            >
              <div className="w-[230px] h-full  p-2  ">
                ...
                >
                  The Bird of Paradise plant is a stunning addition to any
                  indoor space, known for its large, lush green leaves and
                  exotic appeal.
                </p>
                <div>
                  <img
      ...
      {/* What Clients say! */}
      <section
        className={`w-full  p-20 ${darkMode ? "bg-gray-800 " : "bg-[#F0F9EB]"}`}
      >
        <div className="flex flex-col  w-[90%] m-auto mb-20 md:flex-row justify-between text-center">
          ...
          <div className={`w-[120px] flex justify-between  m-auto md:m-0`}>
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
            >
      ...
      >
        <div className="text-center lg:text-left max-w-screen-lg px-4">
          <p className="text-[#5AAC38] text-3xl md:text-3xl lg:text-4xl font-semibold">
            “ On our website, you won’t just enjoy nature—you’ll become a part
            of it and live within it. 🌿✨ ”
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl  leading-tight ">
            We’re your online destination. We offer a wide range of various
  ...
  return (
    <motion.div
      ...
      className={`border-[1px] border-[#889F79] rounded-md flex w-[350px] h-auto text-[#4B633B] lg:w-[480px] ${
        darkMode ? "text-[#E8FFDE] bg-gray-800 border-none" : "text-[#4B633B]"
      }`}
    >
      <div
      ...
      <div className="pt-5 pl-3  ">
        ...
        <p className="pt-2 pb-2">
          <del className="text-gray-500 font-semibold">{delPrice}</del>

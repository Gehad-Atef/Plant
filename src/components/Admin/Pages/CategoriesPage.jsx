...
export default function CategoryPage() {
    ...
    const handleDeleteSelected = () => {
        ...
        Promise.all(
            selectedCategories.map((id) =>
                axios.delete(`https://greenland.runasp.net/Category/${id}`, {
    ...
    const handleEditCategory = async () => {
        ...
        if (editingCategory.imageFile) {
            formData.append("imageFile", editingCategory.imageFile);
        }

        try {
            await axios.put(
                `https://greenland.runasp.net/Category/${editingCategory.id}`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,

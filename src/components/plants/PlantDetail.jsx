...
const PlantDetail = () => {
  ...
  const handleQuantityChange = (e) => {
    const newQuantity = Math.max(1, Math.min(e.target.value, plant?.quantity));
                    ...
                    <div className="text-gray-700 dark:text-gray-300 space-y-2 leading-relaxed">
                      {plant.description
                        ...
                        .map((line, index) => {
                          ...
                          if (
                            text.includes("الوقاية") ||
                            text.includes("فحص") ||
                            text.includes("مبيدات")
                          ) {
                            return (
                              <p key={index}>
                          ...
                          // أي جملة تانية بدون كلمات مفتاحية
                      ...
                      {plant.how_To_Plant
                        ...
                        .map((line, index) => {
                          ...
                          const formatLine = (text) => {
                            ...
                            // السطر لا يحتوي على كلمات مفتاحية
                            return <p key={index}>• {text}.</p>;
                          };

                          return formatLine(trimmed);
                        })}
                    </div>
                  )}
                  {activeTab === "availability" && (

...
const Categories = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto p-6">
      {/* Hero Section (show only when search is empty) */}
      {searchQuery.trim() === "" && (
        <section className="flex flex-col md:flex-row items-center justify-between bg-green-50 dark:bg-gray-800 rounded-3xl p-8 md:p-12 mb-12 shadow-lg">
          ...
          <div className="w-full md:w-1/2 pr-0 md:pr-10 mb-6 md:mb-0">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Everything about plants, from gardening tips and houseplant care
              to exploring different species and their benefits. Your ultimate
